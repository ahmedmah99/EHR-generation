...
public class HealthyGen {


    File file;
    FileWriter writer;
    public HealthyGen(File file, FileWriter fileWriter){
        this.file = file;
        this.writer = fileWriter;
    };

    public void HealthyPeopleStartFunc() throws IOException {


        List<List<String>> allRecords = new ArrayList<List<String>>(50000); //76 column & 37,845 row
